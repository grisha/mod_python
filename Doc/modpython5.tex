...
\begin{tableiii}{l|c|l}{textrm}{Key}{Required Value}{Notes}
  ...
  \lineiii{ApplicationPath}{ }{Deprecated, use mod_python.session.application_path}
  \lineiii{session_cookie_name}{ }{Deprecated, use mod_python.session.cookie_name}
  \lineiii{session_directory}{ }{Deprecated, use mod_python.session.database_directory}
  \lineiii{session_dbm}{ }{Deprecated, use mod_python.dbm_session.database_filename}
  \lineiii{session_cleanup_time_limit}{ }{Deprecated, use mod_python.file_session.cleanup_time_limit}
  ...
  \lineiii{PSPDbmCache}{ }{Deprecated, use mod_python.psp.cache_database_filename}
\end{tableiii}
