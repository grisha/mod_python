...
The session information is stored in a dbmfile named
\file{psp_sess.dbm} and stored in a temporary directory returned by
\code{tempfile.gettempdir()} standard library function. It can be
overriden by setting \code{PythonOption PSPSessionDbm filename}.
