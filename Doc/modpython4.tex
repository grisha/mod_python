...
\begin{funcdesc}{Session}{req\optional{, sid, secret, timeout, lock, lockfile}}
  ...
  instance of \class{DbmSession} or \class{MemorySession}. It takes
  same arguments as \class{BaseSession}.
...
\begin{classdesc}{MemorySession}{req, \optional{, sid, secret, dbmtype, timeout}}
...
\begin{classdesc}{DbmSession}{req, \optional{, dbm, sid, secret, dbmtype, timeout}}
  ...
  function. It can be overriden by setting \code{PythonOption
  SessionDbm filename}.
