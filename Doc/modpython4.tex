...
Reads all or up to \var{sizehint} lines using \method{readline} and
returns a list of the lines read.
\end{methoddesc}
...
request object. Some of the functions in the \module{util}
...
\var{req} is an instance of the mod_python request object.
